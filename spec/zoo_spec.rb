...
RSpec.describe Zoo do
  ...
  #iteration3
  it 'can see if animals are older than a certain number of weeks' do
     animal_1 = Animal.new("Sea Otter", 10, 25)
     animal_2 = Animal.new("Red Panda", 5, 70)
  ...
  it 'sorts animals by weight' do
    ...
    it 'creates a hash' do
      ...
      expect(@zoo.animal_hash).to eq({"C" => [animal_3], "D" => [animal_4, animal_5], "R" => [animal_2], "S" => [animal_1]})
    end
